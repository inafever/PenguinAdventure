...
- 주인공 스프라이트는 `assets/main-characters/`의 `right` 프레임을 씁니다. 펭귄 프레임은 모두 188×264라서 자르면 흔들립니다. 선택 창 썸네일은 `walk_right_1` 정지 이미지입니다. 플레이 중 그리기 크기는 히트박스(72×84) 안에 contain으로 맞춰 가로로 긴 물범이 커 보이지 않게 합니다.
